...
function vendorApplicationPayload(input: VendorApplicationInput) {
  return {
    ...
    preferred_language: input.company.preferredLanguage ?? null,
    website_url: input.company.websiteUrl ?? null,
    public_contact_email: input.company.publicContactEmail ?? null,
    public_contact_phone: input.company.publicContactPhone ?? null,
    contact_name: input.contactName,
...
export async function updateCompanyProfile(
  ...
  const profilePayload = {
    ...
    public_contact_phone: patch.publicContactPhone ?? null,
