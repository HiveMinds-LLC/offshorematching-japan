          ...
          {activeView === "create" ? (
            <div className="grid gap-6 lg:grid-cols-2">
              ...
              <Card className="grid gap-4">
                ...
                <div className="grid gap-3">
                  <label className="grid gap-1.5">
                    <span className="field-label">{locale === "en" ? "Company Name" : "会社名"}</span>
                  ...
                  <div className="grid gap-3 md:grid-cols-2">
                    <label className="grid gap-1.5">
                      <span className="field-label">{locale === "en" ? "Contact Name" : "担当者名"}</span>
                  ...
                  <label className="grid gap-1.5">
                    <span className="field-label">{locale === "en" ? "Login Email" : "ログインメール"}</span>
                  ...
                  <label className="grid gap-1.5">
                    <span className="field-label">{locale === "en" ? "Initial Password (min 8 chars)" : "初期パスワード（8文字以上）"}</span>
                  ...
                  <div className="grid gap-3 md:grid-cols-2">
                    ...
                    <label className="grid gap-1.5">
                      <span className="field-label">{locale === "en" ? "Access End Date" : "利用終了日"}</span>
